 ...
 * @author Sixto Castro
 */
public final class WTinyLFU_LRU {
    public static LRUCache lru;
    public Window_LRUCache windowCache;
    ...
    public WTinyLFU_LRU(int capacity, double percentMainCache, double percentWC){ // WC->% Window Cache
        int mainCacheCapacity = (int) (capacity*percentMainCache);                                                
        windowCacheCapacity = (int)(capacity*percentWC);
        this.totalCapacity = capacity;
        this.lru = new LRUCache(mainCacheCapacity);
        this.windowCache = new Window_LRUCache(windowCacheCapacity);
    ...
    public String get(String key){
        ...
        if(lru.get(key) == null)
            ...
            increment(key);
            //System.out.println("item en lru cache: "+key);
            return key;
        }
